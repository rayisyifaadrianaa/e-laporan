                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h4 mb-4">Silahkan Masuk</h1>
                                    ...
                                    <form class="user" method="POST" action="<?php echo base_url(); ?>login/do_login">
                                        ...
                                        <center class="mt-4">
                                            <button class="btn btn-info" style="width: 50%;">
                                                Login
                                            </button>
                                        </center>
                                        <!-- <hr>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?php echo base_url(); ?>login/register" style="color: white;">Belum punya akun? daftar disini!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
